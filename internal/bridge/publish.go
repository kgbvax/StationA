...
// per the station model §8. Non-retained telemetry stays QoS 0.
...
// publishDiscovery serializes a ha.DiscoveryConfig to JSON and publishes it to
// the config topic (always retained, so HA picks it up on its restart).
