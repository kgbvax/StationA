...
**MQTT broker:** a bauwagen-local Mosquitto on scmino (`192.168.1.178:1883`,
alias `bwbroker` — the shari services connect over the LAN), bridged to the HA
broker at `192.168.1.50:1883` (see `docs/conventions/mqtt-topology.md`).
Persistent store.
